<?php
/**
 * Eléctrico Theme: Color Patterns
 *
 * @package WordPress
 ...
 */
function electrico_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Eléctrico Theme default saturation level.
	 *
	 * @since Eléctrico Theme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'electrico_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.electrico-front-page) .entry-title,
...
.colors-custom .electrico-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.electrico-front-page .panel-content .recent-posts article,
...
.colors-custom.electrico-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Eléctrico Theme custom colors CSS.
	 *
	 * @since Eléctrico Theme 1.0
	 *
	 ...
	 */
	return apply_filters( 'electrico_custom_colors_css', $css, $hue, $saturation );
}
