...
if( ! class_exists( 'Showcase_Taxonomy_Images' ) ) {
  class Showcase_Taxonomy_Images {
     ...
     */
     ...
     // Image actions
     add_action( 'portfolio_cat_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
     add_action( 'created_portfolio_cat', array( $this, 'save_category_image' ), 10, 2 );
     add_action( 'portfolio_cat_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
     add_action( 'edited_portfolio_cat', array( $this, 'updated_category_image' ), 10, 2 );
     add_action( 'admin_enqueue_scripts', array( $this, 'load_media' ) );
     add_action( 'admin_footer', array( $this, 'add_script' ) );
   }

   public function load_media() {
     if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'portfolio_cat' ) {
       return;
     }
     wp_enqueue_media();
   }
