...
if(!empty($gmap_show)&&$gmap_show=='true'&&!empty($gmap_link)):
$output.='<div id="gmap-'.uniqid().'" class="el_gmap"><iframe border="0" width="100%" height="100%" src="'.$gmap_link.'"></iframe></div>';
endif;
